...
if ($result_frp_server->num_rows > 0) { //遍历目录
    ...
    <div class="card-body">
      ...
      <form action="config_download_tcp.php" method="get">
        ...
        <input type="text" class="form-control" id="local_ip" name="local_ip" placeholder="本地IP" value="'.$local_ip.'">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="remote_port" name="remote_port" placeholder="远程端口" value="'.$remote_port.'">
      </div>
      <div class="form-group">
